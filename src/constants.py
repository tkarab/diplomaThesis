...
RESULTS_PATH_ALL_EXPERIMENTS = ROOT + r'\Δεδομένα\Results'
RESULTS_PATH_EX1  = RESULTS_PATH_ALL_EXPERIMENTS + r'\Experiment 1'
RESULTS_PATH_EX2A = RESULTS_PATH_ALL_EXPERIMENTS + r'\Experiment 2a'
RESULTS_PATH_EX2B = RESULTS_PATH_ALL_EXPERIMENTS + r'\Experiment 2b'
RESULTS_PATH_EX3  = RESULTS_PATH_ALL_EXPERIMENTS + r'\Experiment 3'
RESULTS_PATH_EX4  = RESULTS_PATH_ALL_EXPERIMENTS + r'\Experiment 4'
