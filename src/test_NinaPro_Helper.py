...
s = 1
exercise = 1
# s_path = constants.getRaw_subject_exercise_file_path(s, exercise)
# path = constants.getRaw_DB_Subject_path(DB, s)
# data = get_data(path, s_path)
# train_reps = [1,3,4,6]
# norm_data = normalise(data, train_reps)
# windowing(norm_data, train_reps, list(range(1,18)) ,200, 50)
